...
for f in migrate-im-schema.sql migrate-payment-schema.sql migrate-user-real-name.sql migrate-payment-order-center.sql migrate-payment-royalty-settle.sql migrate-activity-social.sql migrate-post-view-count.sql; do
